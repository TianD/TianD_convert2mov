...
class Ui_toMOVMainWindow(object):
    ...
    def setupUi(self, toMOVMainWindow):
        ...
        #
        self.horizontalLayout_3 = QtGui.QHBoxLayout(self.rightWidget)
    ...
    def retranslateUi(self, toMOVMainWindow):
        ...
        self.reorderBtn.setText(_translate("toMOVMainWindow", "reorder", None))
        ...
        self.runBtn.setText(_translate("toMOVMainWindow", "run", None))
