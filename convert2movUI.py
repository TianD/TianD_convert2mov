...
class Ui_toMOVMainWindow(object):
    ...
    def setupUi(self, toMOVMainWindow):
        ...
        self.reorderBtn = QtGui.QPushButton(self.rightWidget)
        self.reorderBtn.setObjectName(_fromUtf8("reorderBtn"))
        self.verticalLayout.addWidget(self.reorderBtn)
        #
        self.horizontalLayout_3 = QtGui.QHBoxLayout()
        self.buttongroup = QtGui.QButtonGroup()
        self.toMovRadioBtn = QtGui.QRadioButton(self.rightWidget)
        self.horizontalLayout_3.addWidget(self.toMovRadioBtn)
        self.buttongroup.addButton(self.toMovRadioBtn)
        self.upLoadRadioBtn = QtGui.QRadioButton(self.rightWidget)
        self.horizontalLayout_3.addWidget(self.upLoadRadioBtn)
        self.buttongroup.addButton(self.upLoadRadioBtn)
        self.radioSpacerItem = QtGui.QSpacerItem(600, 10, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(self.radioSpacerItem)
        self.verticalLayout_2.insertLayout(0, self.horizontalLayout_3)
        #
        self.runBtn = QtGui.QPushButton(self.rightWidget)
    ...
    def retranslateUi(self, toMOVMainWindow):
        ...
        self.reorderBtn.setText(_translate("toMOVMainWindow", "重排序", None))
        #self.toMOVBtn.setText(_translate("toMOVMainWindow", "toMOV", None))
        #self.upLoadBtn.setText(_translate("toMOVMainWindow", "upLoad", None))
        self.upLoadRadioBtn.setText(_translate("toMOVMainWindow", "上传", None))
        self.toMovRadioBtn.setText(_translate("toMOVMainWindow", "转MOV", None))
        self.runBtn.setText(_translate("toMOVMainWindow", "运行", None))
